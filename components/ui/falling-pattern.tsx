...
type FallingPatternProps = React.ComponentProps<'div'> & {
	/** Primary color of the falling elements (default: '#c5a059') */
	color?: string;
		...
		<div className={cn('relative h-full w-full', className)}>
			...
			<div
				...
				style={{
					...
					backgroundImage: `radial-gradient(circle at 50% 50%, transparent 0, transparent 2px, ${backgroundColor === 'transparent' ? 'black' : backgroundColor} 2px)`,
